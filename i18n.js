const i18n = {
  en: {
    ...
    research: {
      ...
      proj3_title: "Independent Research Project",
      proj3_date: "2026",
      proj3_content:
        'Proved that the entropy JKO map is nonexpansive on Gaussian inputs. <a href="Entropy_JKO_Nonexpansivity_on_Gaussian_Inputs.pdf" target="_blank" rel="noopener">PDF</a>',
    },
    ta: {
    ...
    education: {
      ...
      course6: "Functional Analysis",
      course7: "Differential Geometry",
      course8: "Combinatorics",
      course9: "Topology",
  ...
  zh: {
    ...
    research: {
      ...
      proj3_date: "2026年",
      proj3_content:
        '证明了当自变量为高斯测度时，熵JKO映射是非扩张的。<a href="Entropy_JKO_Nonexpansivity_on_Gaussian_Inputs.pdf" target="_blank" rel="noopener">PDF</a>',
    },
    ta: {
      title: "助教 – 胡博睿",
      header: "助教",
  ...
  fr: {
    ...
    home: {
      ...
      contact: "Contact : boruihu2006[at]gmail.com",
      updated: "Mis à jour le 30/07/2026",
    },
    about: {
    ...
    research: {
      ...
      proj3_title: "Projet de recherche indépendant",
      proj3_date: "2026",
      proj3_content:
        'Preuve que l\'application JKO d\'entropie est non-expansive lorsqu\'elle est évaluée sur des mesures gaussiennes. <a href="Entropy_JKO_Nonexpansivity_on_Gaussian_Inputs.pdf" target="_blank" rel="noopener">PDF</a>',
    },
    ta: {
    ...
    education: {
      ...
      course6: "Analyse fonctionnelle",
      course7: "Géométrie différentielle",
      course8: "Combinatoire",
      course9: "Topologie",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  navWrapper.setAttribute("data-no-translate", "");
