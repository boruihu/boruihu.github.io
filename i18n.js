const i18n = {
  en: {
    ...
    about: {
      ...
      header: "About Me",
      para1: "I study pure mathematics, currently leaning toward analysis and PDE.<br><br>I am also interested in optimization theory.",
      para2:
  ...
  zh: {
    ...
    about: {
      title: "关于 – 胡博睿",
      header: "关于我",
      para1: "我的方向是基础数学，目前偏向于分析与偏微分方程。<br><br>我对最优化理论也很感兴趣。",
      para2:
  ...
  fr: {
    ...
    about: {
      ...
      para1: "J'étudie les mathématiques pures, avec actuellement un penchant pour l'analyse et les EDP.<br><br>Je m'intéresse aussi à la théorie de l'optimisation.",
      para2:
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  bottomBarRight.appendChild(menuWrapper);
